...
Original file is located at
    https://colab.research.google.com/github/d2l-ai/d2l-en-colab/blob/master/chapter_computer-vision/neural-style.ipynb
...
content_img = image.imread(os.path.expanduser("~/Development/git/mxnet-cookbook/_resources/rainier.jpg"))
style_img = image.imread(os.path.expanduser("~/Development/git/mxnet-cookbook/_resources/The_Great_Wave_of_Kanagawa.jpg"))
...
content_weight, style_weight, tv_weight = 0.1, 1e3, 10
...
ctx, image_shape = mx.gpu(0), (225, 150)
...
for factor in (2, 3, 4):
    image_shape = (225 * factor, 150 * factor)
